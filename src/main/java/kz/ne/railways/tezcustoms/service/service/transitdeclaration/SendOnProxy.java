...
public class SendOnProxy {
	...
	private static final String requestBodyTemplate = "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:new=\"http://new.webservice.namespace\"><soap:Header/><soap:Body><new:SaveDeclaration><parameter><new:username>"+userTemplate+"</new:username><new:passwod>"+passwordTemplate+"</new:passwod><new:customsCode>"+customsCodeTemplate+"</new:customsCode><new:xml><![CDATA["+xmlTemplate+"]]></new:xml></parameter></new:SaveDeclaration></soap:Body></soap:Envelope>";
	...
	public SendOnProxy(String customsUser, String customsPassword, String customsCode, String proxyHost, String proxyPort) {
...
//	    	  }
	...
	private String createRequestBody(String xml) {
		return requestBodyTemplate
				.replace(userTemplate, (getCustomsUser() != null ? getCustomsUser() : ""))
