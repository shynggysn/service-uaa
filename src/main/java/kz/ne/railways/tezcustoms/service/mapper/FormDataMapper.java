...
public class FormDataMapper {
    ...
    private String transitDirectionCode; // Назн. пред.информации
    ...
    public FormData toFormData(){
        ...
        BeanUtils.copyProperties(this, formData);
        formData.setExpeditor(buildExpeditor());
        formData.setDeclarant(buildtDeclarant());
        return formData;
    }

    private Expeditor buildExpeditor(){
        Address address = buildExpeditorAddress();
        Personal personal = buildExpeditorPersonal();
        return new Expeditor(
                getExpeditorName(),
                getExpeditorShortName(),
                getExpeditorCountry(),
                getExpeditorCountryName(),
                getExpeditorIndex(),
                address,
                personal
        );
    ...
    private Address buildExpeditorAddress(){
        return new Address(
                getExpeditorCity(),
                getExpeditorRegion(),
                getExpeditorAddress()
    ...
    private Personal buildExpeditorPersonal(){
        return new Personal(
                getExpeditorKZBin(),
                getExpeditorKZIin(),
    ...
    private Declarant buildtDeclarant(){
        Address address = buildDeclarantAddress();
        Personal personal = buildDeclarantPersonal();
        return new Declarant(
                getDeclarantName(),
                getDeclarantShortName(),
                getDeclarantCountry(),
    ...
    private Address buildDeclarantAddress(){
        return new Address(
                getDeclarantCity(),
                getDeclarantRegion(),
                getDeclarantAddress()
    ...
    private Personal buildDeclarantPersonal(){
        return new Personal(
                getDeclarantKZBin(),
                getDeclarantKZIin(),
